...
void Motor_StopAll(void)
{
    PWM_SetCompareA(0U);
    PWM_SetCompareB(0U);
    DL_GPIO_clearPins(BOARD_OUTPUTS_MOTOR_AIN1_PORT,
                      BOARD_OUTPUTS_MOTOR_AIN1_PIN);
    DL_GPIO_clearPins(BOARD_OUTPUTS_MOTOR_AIN2_PORT,
                      BOARD_OUTPUTS_MOTOR_AIN2_PIN);
    DL_GPIO_clearPins(BOARD_OUTPUTS_MOTOR_BIN1_PORT,
                      BOARD_OUTPUTS_MOTOR_BIN1_PIN);
    DL_GPIO_clearPins(BOARD_OUTPUTS_MOTOR_BIN2_PORT,
                      BOARD_OUTPUTS_MOTOR_BIN2_PIN);
}

void Motor_Brake(void)
{
    DL_GPIO_setPins(BOARD_OUTPUTS_MOTOR_AIN1_PORT,
                    BOARD_OUTPUTS_MOTOR_AIN1_PIN);
    DL_GPIO_setPins(BOARD_OUTPUTS_MOTOR_AIN2_PORT,
                    BOARD_OUTPUTS_MOTOR_AIN2_PIN);
    DL_GPIO_setPins(BOARD_OUTPUTS_MOTOR_BIN1_PORT,
                    BOARD_OUTPUTS_MOTOR_BIN1_PIN);
    DL_GPIO_setPins(BOARD_OUTPUTS_MOTOR_BIN2_PORT,
                    BOARD_OUTPUTS_MOTOR_BIN2_PIN);

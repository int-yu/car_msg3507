...
static const Param_Entry_t s_params[] = {
    ...
    { "h2arm", Param_GetH2MarkerArm, Param_SetH2MarkerArm,
      ACCOMPLISH_26H_FINISH_MARKER_MIN_DISTANCE_MM, 20000.0f },
    ...
    { "k2mt", Param_GetKey2NegativeMaxTilt,
      Param_SetKey2NegativeMaxTilt, 0.1f,
      BALL_SEQUENCE_MAX_CONFIGURABLE_TILT_DEG },
    ...
    { "k2pmt", Param_GetKey2PositiveMaxTilt,
      Param_SetKey2PositiveMaxTilt, 0.1f,
      BALL_SEQUENCE_MAX_CONFIGURABLE_TILT_DEG },

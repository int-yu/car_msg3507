...
#define MOTION_LINE_INNER_WEIGHT          2       /* 内侧通道的权重绝对值。 */
...
#define MOTION_LINE_CURVE_EXIT_ANGLE_DEG  178.0f   /* Relative yaw change that returns to straight. */
...
extern float MotionLine_TuneCurveMaxAdjustRatio;
extern float MotionLine_TuneCurveWeightKd;
